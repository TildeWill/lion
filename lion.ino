...
#define BUTTON 14 //virtual pins 14-19 are the analog pins in digital form
...
void setup() {
  ...
  Mp3SetVolume(20, 20); //Set initial volume (20 = -10dB) Manageable
